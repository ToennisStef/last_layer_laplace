...
Zero-friction capture. Dump anything here mid-session; no structure required, no
line is too small. **This file gets emptied**, it is not a record.

Routing pass (when a run finishes, or Friday — whichever actually happens):

| Line is about... | Goes to |
|---|---|
| why I picked X over Y | [doc/decisions/](doc/decisions/) — new numbered record |
...
Then delete the line from here. Empty file = pass done.
